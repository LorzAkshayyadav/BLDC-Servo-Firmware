...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB1     ------> ADC1_INP5
    */
    GPIO_InitStruct.Pin = PHASE_B_ISENSE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(PHASE_B_ISENSE_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    PC0     ------> ADC2_INP10
    */
    GPIO_InitStruct.Pin = PHASE_C_ISENSE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(PHASE_C_ISENSE_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_INP5
    */
    HAL_GPIO_DeInit(PHASE_B_ISENSE_GPIO_Port, PHASE_B_ISENSE_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC0     ------> ADC2_INP10
    */
    HAL_GPIO_DeInit(PHASE_C_ISENSE_GPIO_Port, PHASE_C_ISENSE_Pin);
