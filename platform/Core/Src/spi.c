...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  */
    ...
    PB5     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = POS_ENC_MISO_Pin|POS_ENC_CLK_Pin|POS_ENC_MOSI_Pin;
  ...
  */
    ...
    PB14     ------> SPI2_MISO
    */
    GPIO_InitStruct.Pin = LAN9253_SCK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI2;
    HAL_GPIO_Init(LAN9253_SCK_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = LAN9253_SI_Pin|LAN9253_SO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI2;
  ...
  */
    ...
    PC12     ------> SPI3_MOSI
    */
    GPIO_InitStruct.Pin = MOTOR_ENC_CS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF6_SPI3;
    HAL_GPIO_Init(MOTOR_ENC_CS_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = MOTOR_ENC_MISO_Pin|MOTOR_ENC_CLK_Pin|MOTOR_ENC_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF6_SPI3;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PB5     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, POS_ENC_MISO_Pin|POS_ENC_CLK_Pin|POS_ENC_MOSI_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB14     ------> SPI2_MISO
    */
    HAL_GPIO_DeInit(LAN9253_SCK_GPIO_Port, LAN9253_SCK_Pin);

    HAL_GPIO_DeInit(GPIOB, LAN9253_SI_Pin|LAN9253_SO_Pin);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(MOTOR_ENC_CS_GPIO_Port, MOTOR_ENC_CS_Pin);

    HAL_GPIO_DeInit(GPIOC, MOTOR_ENC_MISO_Pin|MOTOR_ENC_CLK_Pin|MOTOR_ENC_MOSI_Pin);
