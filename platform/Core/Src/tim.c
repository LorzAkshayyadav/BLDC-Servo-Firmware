...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    PA6     ------> TIM1_BKIN
    */
    GPIO_InitStruct.Pin = STO2_TIM1_BKIN2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(STO2_TIM1_BKIN2_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = STO1_TIM1_BKIN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(STO1_TIM1_BKIN_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    PC7     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = LAN9253_SYNC0_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(LAN9253_SYNC0_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM15_MspInit 0 */
    ...
    PE3     ------> TIM15_BKIN
    */
    GPIO_InitStruct.Pin = STO2_TIM15_BKIN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_TIM15;
    HAL_GPIO_Init(STO2_TIM15_BKIN_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE13     ------> TIM1_CH3
    */
    GPIO_InitStruct.Pin = PWM_INL_B_Pin|PWM_INH_B_Pin|PWM_INL_A_Pin|PWM_INL_C_Pin
                          |PWM_INH_A_Pin|PWM_INH_C_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PB6     ------> TIM4_CH1
    */
    GPIO_InitStruct.Pin = POS_ENC_GETSENS_Pin|MOTOR_ENC_GETSENS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PE13     ------> TIM1_CH3
    */
    HAL_GPIO_DeInit(GPIOE, STO2_TIM1_BKIN2_Pin|PWM_INL_B_Pin|PWM_INH_B_Pin|PWM_INL_A_Pin
                          |PWM_INL_C_Pin|PWM_INH_A_Pin|PWM_INH_C_Pin);

    HAL_GPIO_DeInit(STO1_TIM1_BKIN_GPIO_Port, STO1_TIM1_BKIN_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PC7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(LAN9253_SYNC0_GPIO_Port, LAN9253_SYNC0_Pin);
  ...
  /* USER CODE END TIM15_MspDeInit 0 */
    ...
    PE5     ------> TIM15_CH1
    */
    HAL_GPIO_DeInit(GPIOE, STO2_TIM15_BKIN_Pin|BRAKE_PWM_Pin);
